 ...
 * Class Maps.
 */
class LeafletMaps extends \LeafletObjects {
  ...
  public function hook_menu(&$items) {
    ...
    $items['admin/structure/leaflet/maps']['type'] = MENU_LOCAL_TASK;
    $items['admin/structure/leaflet/maps']['context'] = MENU_CONTEXT_PAGE | MENU_CONTEXT_INLINE;
    $items['admin/structure/leaflet/maps']['weight'] = -10;
  }
  ...
  public function delete_form_submit(&$form_state) {
    ...
    if (\Drupal::service('module_handler')->moduleExists('leaflet_block')) {
      $delta = _leaflet_block_get_block_id($form_state['item']->machine_name);

      db_delete('block')
        ->condition('module', 'leaflet')

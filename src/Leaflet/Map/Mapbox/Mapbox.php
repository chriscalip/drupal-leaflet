...
namespace Drupal\leaflet\Map;
use Drupal\leaflet\Config;
use Drupal\leaflet\Types;

$plugin = array(
  'class' => '\\Drupal\\leaflet\\Map\\Mapbox',
);

/**
 * Class Mapbox.
 */
class Mapbox extends \Drupal\leaflet\Types\Map {
  ...
  public function optionsForm(&$form, &$form_state) {
    ...
    if ($this->machine_name != Config::get('leaflet.edit_view_map')) {
      $map = leaflet_object_load('Map', Config::get('leaflet.edit_view_map'));
